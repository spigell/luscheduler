// taken from https://github.com/vadv/zalua/blob/master/src/zalua/dsl/json.go
package dsl
...
func (c *dslState) dslJsonDecode(L *lua.LState) int {
	str := L.CheckString(1)
...
func (c *dslState) dslJsonEncode(L *lua.LState) int {
	value := L.CheckAny(1)
